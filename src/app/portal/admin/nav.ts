	...
	G("members", "Members & Access", [
		{
			segment: "list",
			label: "Member List",
			description: "Invite members by exact email and see who has signed in.",
			permission: "member:manage",
		},
		{ segment: "roles", label: "Roles & Access", description: "Grant admin roles to members.", permission: "role:assign" },
	]),
	G("content", "Content", [
		{ segment: "links", label: "Short Links", description: "Moderate member short links and shared stats.", permission: "link:moderate" },
	]),
	G("system", "System", [
		{ segment: "nav-pins", label: "Pinned Nav Links", description: "Links shown in every member nav.", permission: "nav:configure" },
	]),
];
