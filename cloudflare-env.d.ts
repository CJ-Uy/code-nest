/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 4eecbfdc8ffec557aa86ba92dca22790)
...
interface __BaseEnv_CloudflareEnv {
	...
	DEMO_MODE: "true";
	NEXTJS_ENV: string;
	WORKER_SELF_REFERENCE: Fetcher /* code-nest */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEMO_MODE" | "NEXTJS_ENV">> {}
}
