/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 742d3e41be1c73b0d63ff965e5c86718)
// Runtime types generated with workerd@1.20260603.1 2026-06-10 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	...
	NEXTJS_ENV: string;
	WORKER_SELF_REFERENCE: Fetcher /* code-nest-dev */ | Service<typeof import("./.open-next/worker").default>;
}
declare namespace Cloudflare {
	...
	interface DevEnv {
		...
		LOCAL_STORAGE_DIR: "./.local/uploads";
		NEXTJS_ENV: string;
		WORKER_SELF_REFERENCE: Fetcher /* code-nest-dev */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "STORAGE_MODE" | "LOCAL_SQLITE_PATH" | "LOCAL_STORAGE_DIR" | "NEXTJS_ENV">> {}
}
