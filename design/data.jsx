// ===== Ateneo CODE — content data (from CONTENT REFERENCE) =====
const ORG = {
  name: "Ateneo CODE",
  ...
  blurb: "A youth-led, non-profit organization conducting contextualized Organization Development (OD) services to empower youth organizations to better serve the nation.",
};

const VISION = "We, the Ateneo Consultants for Organization Development and Empowerment, imbued with Ignatian Values, envision a society of developed individuals by forming sustainable environments conducive for people to flourish. Through the practice of Organization Development, we aim to form the Youth and Youth-Oriented Organizations who will initiate positive change within the community.";

const MISSION = "Our mission is to empower the youth to continually develop their organizations and engage in nation-building. This is achieved through the promotion of Organization Development (OD) and the implementation of contextualized OD services by our trained consultants.";
...
const WHAT_IS_OD = "Organization Development is a process of planned change in an organization's culture — focused on increasing the organization's effectiveness and health through planned interventions that help organizations adapt to change, with the help of consultants. It is the tool CODE uses to pursue its advocacy of planned change and youth empowerment, building consultant capability through constant research and practice.";

const SERVICES_INTRO = "CODE caters to clients with services tailor-fit to their specific needs instead of generalized programs. We do heavy research so that each engagement is unique and exceptional.";
...
const SERVICES = [
  {
    ...
    summary:"Train, develop, and strengthen the knowledge, skills, and attitudes of a client org's members through modules tailored to their context.",
  ...
  },
  {
    ...
    points:["Vision & Mission","Organizational Diagnosis","Constitution","Code of Internal Procedures","Processes, Systems & Structures","Member Development & Retention"],
  },
  {
    id:"teams",
    tag:"Advisory",
    title:"Consultancy Teams",
    summary:"Focus on organization-wide issues in a more advisory, facilitative role — helping the client reach a concrete plan of action by the end.",
...
const PROJECTS = [
  {
    ...
    stat:[{k:"Empathy",v:"at its core"},{k:"SHS–College",v:"nationwide reach"}],
  },
  {
    id:"xchange",
    short:"XC",
    ...
    summary:"An annual OD seminar for youth organization leaders who want to be servant leaders for the nation — via plenary talks, OD workshops and modules, and inter-org collaboration.",
    goals:[
    ...
    stat:[{k:"160+",v:"partner organizations"},{k:"30+",v:"universities & non-profits"}],
  },
];
...
// ===== Product Center articles (public) =====
const ARTICLES = [
  {
  ...
  },
  {
    ...
    abstract:"Change happens to every organization; planned change is what happens on purpose. This piece outlines how OD sequences diagnosis, intervention, and reinforcement so that change takes root rather than snapping back the moment attention moves elsewhere.",
    sections:[
      { h:"Diagnosis before action", figure:"Diagram — the planned-change sequence", body:"Planned change starts with honest diagnosis: what is actually happening, and why. Skipping this step is the most common reason interventions fail to hold." },
    ],
    components:{
      title:"Three Phases",
      items:[
...
const ARTICLE_CATS = ["All","Foundations","Methods"];

Object.assign(window, { ORG, VISION, MISSION, COMPETENCIES, WHAT_IS_OD, SERVICES_INTRO, SERVICES, PROJECTS, CONTACTS, ARTICLES, ARTICLE_CATS });
